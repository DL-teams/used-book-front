...
export const userLogin = (params) => {
  return http.fetchPost('/ums/login', params)
}
// 退出登陆
export const loginOut = (params) => {
  return http.fetchGet('/users/loginOut', params)
}
// 用户信息
export const userInfo = (params) => {
  return http.fetchGet('/ums/checkLogin', params)
}
// 注册账号
export const register = (params) => {
  return http.fetchPost('/ums/register', params)
}
// 上传图片
export const upload = (params) => {
  return http.fetchPost('/ums/upload', params)
}
// 修改头像
...
export const productHome = (params) => {
  return http.fetchGet('/ums/home', params)
}
// 首页接口
...
// 积分增加
export const openSignIn = (params) => {
  return http.fetchPost('/users/points-update', params)
}
// 余额增加
export const updateBalance = (params) => {
  return http.fetchPost('/users/balance-update', params)
}
